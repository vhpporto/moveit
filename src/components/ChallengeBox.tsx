                ...
                <div className={styles.challengeActive}>
                    ...
                    <main>
                        ...
                        <footer>
                            ...
                            <button type='button' onClick={handleChallengeSucceeded } className={styles.challengeCompleteButton}>Completei</button>
                            
                        </footer>
                </div>
            ) : (
                <div className={styles.challengeNotActive}>
                <strong>Finalize um clico para receber um novo desafio</strong>
                <p>
